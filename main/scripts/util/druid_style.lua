...
M["button"] = {
	HOVER_SCALE = vmath.vector3(0.03, 0.03, 1),
	HOVER_MOUSE_SCALE = vmath.vector3(0.04, 0.04, 1),
	HOVER_TIME = 0.05,
	SCALE_CHANGE = vmath.vector3(0.03, 0.03, 1),
	BTN_SOUND = "click",
...
M["scroll"] = {
	...
	FRICT = 0.99, -- mult for free inert
	FRICT_HOLD = 0.8, -- mult. for inert, while touching
	INERT_THRESHOLD = 0.2, -- speed to stop inertion
	INERT_SPEED = 100, -- koef. of inert speed
